...
CREATE STAGE IF NOT EXISTS RAW.RAW_LOAD_STAGE
...
CREATE TABLE IF NOT EXISTS RAW.UCI_SALES (
...
CREATE TABLE IF NOT EXISTS RAW.UCI_RETURNS (
    INVOICE STRING NOT NULL,
    STOCK_CODE STRING NOT NULL,
    DESCRIPTION STRING,
    QUANTITY NUMBER NOT NULL,
...
CREATE TABLE IF NOT EXISTS RAW.UCI_SALES_QUARANTINE (
    INVOICE STRING NOT NULL,
    STOCK_CODE STRING NOT NULL,
    DESCRIPTION STRING,
    QUANTITY NUMBER NOT NULL,
...
CREATE TABLE IF NOT EXISTS RAW.DIM_STORE_SEED (
...
CREATE TABLE IF NOT EXISTS RAW.DIM_PRODUCT_SEED (
